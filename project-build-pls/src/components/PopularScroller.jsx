...
const moviesData = [
  {
    ...
    image:
      "https://m.media-amazon.com/images/M/MV5BNzVjOWEwYjEtNDJhOC00YjUyLThjMWItMDQwZGY1ODM4YzI3XkEyXkFqcGc@._V1_.jpg",
    rating: 4.8,
    year: 2019,
  },
  {
  ...
  },
  {
    ...
    title: "Breaking Bad",
    image:
      "https://mediaproxy.tvtropes.org/width/1200/https://static.tvtropes.org/pmwiki/pub/images/breaking_bad_4.png",
    rating: 4.9,
    year: 2008,
  },
  {
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  initial={{ opacity: 0 }}
                  animate={{
                    opacity: hoveredId === `${movie.id}-${i}` ? 1 : 0,
                  }}
                  transition={{ duration: 0.3 }}
                >
