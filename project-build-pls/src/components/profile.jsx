...
function MyProfile() {
  ...
  const getPostType = (post) => {
    if (
      ...
      post.content?.toLowerCase().includes("anime")
    ) {
      return "Anime";
    } else if (
      post.title?.toLowerCase().includes("manga") ||
      post.content?.toLowerCase().includes("manga")
    ) {
      return "Manga";
    } else {
      return "Book";
            ...
            <div className="px-6">
              <div className="flex flex-col md:flex-row md:items-end">
                ...
                <div className="md:ml-4 flex-1">
                  <h1 className="text-3xl font-bold text-[#F2E9E4]">
                    {user.name}
                  </h1>
            ...
            <motion.div className="lg:col-span-1" variants={itemVariants}>
              <div className="bg-[#1D1135] bg-opacity-70 backdrop-blur-sm rounded-xl p-5 shadow-lg border border-[#6C4AB6] mb-6">
                ...
                <p className="text-[#F2E9E4] mb-4">
                  {user.bio ||
                    "Avid collector of magical lore, anime enthusiast, and theorist extraordinaire. Always looking for hidden meanings in my favorite series."}
                </p>

                <h3 className="text-md font-semibold mb-2 text-[#9B7EDE]">
                  Favorite Genres
                </h3>
                <div className="flex flex-wrap gap-2">
                  {["Fantasy", "Supernatural", "Mystery", "Sci-Fi"].map(
                    (genre, index) => (
                      <motion.span
                        key={index}
              ...
              <div className="bg-[#1D1135] bg-opacity-70 backdrop-blur-sm rounded-xl p-5 shadow-lg border border-[#6C4AB6]">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-[#6C4AB6] bg-opacity-50 p-3 rounded-lg">
                    <div className="text-3xl font-bold text-[#F2E9E4]">
                      {posts.length}
                    </div>
                ...
                <div className="py-4">
                    ...
                    <div>
                      {posts.length > 0 ? (
                        posts.map((post) => (
                          ...
                          >
                            <div className="flex items-center mb-2">
                              <span
                                className={`px-2 py-1 text-xs rounded font-medium mr-2 
                                ${
                                  getPostType(post) === "Anime"
                                    ? "bg-[#6C4AB6] bg-opacity-70"
                                    : getPostType(post) === "Manga"
                                    ? "bg-[#6C4AB6] bg-opacity-70"
                                    : "bg-[#6C4AB6] bg-opacity-70"
                                }`}
                              >
                        ...
                        <div className="flex flex-col items-center py-8 text-center">
                          ...
                          <p className="text-[#F2E9E4] mb-4">
                            Share your first lore discovery or theory with the
                            community.
                          </p>
                          <motion.button
                    ...
                    <div>
                      {comments.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center py-8 text-center">
                          ...
                          <p className="text-[#F2E9E4]">
                            Join discussions by commenting on posts that
                            interest you.
                          </p>
                        </div>
                      )}
                  ...
                  {activeTab === "bookmarks" && (
                    <div className="flex flex-col items-center py-8 text-center">
                      ...
                      <p className="text-[#F2E9E4] mb-4">
                        Save your favorite discussions to read later.
                      </p>
                      <motion.button
                        className="px-4 py-2 bg-[#6C4AB6] hover:bg-[#9B7EDE] transition-colors rounded-lg shadow-md text-[#F2E9E4] font-medium"
                        whileHover={{ scale: 1.05 }}
