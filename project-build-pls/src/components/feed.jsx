...
function Feed() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white">
        ...
        />
        <p className="mt-4 text-lg tracking-wider text-yellow-400">
          Loading the realm...
        </p>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      <main
        className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 transition-all duration-300 ${
                ...
                <div className="p-2">
                    ...
                    <div className="flex items-center">
                      <TrendingUp
                        className={`h-4 w-4 mr-2 ${
                          sortBy === "newest" ? "text-black" : "text-yellow-400"
                        }`}
                      />
                      Newest First
                    </div>
                  ...
                  >
                    <div className="flex items-center">
                      <Star
                        className={`h-4 w-4 mr-2 ${
                          sortBy === "title" ? "text-black" : "text-yellow-400"
                        }`}
                      />
                      Alphabetical
                    </div>
                ...
                <div className="flex justify-between items-center border-t border-zinc-700 pt-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-xs text-gray-300">
                      {post.expand?.created_by?.name || "Unknown"}
                    </span>
                  </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-400 mb-6 max-w-md">
        Be the first to share your epic tale with the LoreVerse community.
      </p>
      <button
        onClick={onCreate}
